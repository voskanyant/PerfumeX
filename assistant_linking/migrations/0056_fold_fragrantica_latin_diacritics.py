...
def normalized_brand_name(value: str) -> str:
    return normalize_alias_value(fold_latin_diacritics(value).replace("&", " and "))


def normalized_product_name(brand_name: str, scent_name: str) -> str:
    text = fold_latin_diacritics(strip_leading_brand(brand_name, scent_name))
...
class Migration(migrations.Migration):
    dependencies = [
        ("assistant_linking", "0055_alter_ailearningproposal_status"),
    ]
