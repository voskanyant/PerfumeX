...
- Supplier brand fields may duplicate the raw row's leading brand text. After recognizing a brand, strip repeated leading occurrences of the same brand or alias before scent extraction so the duplicate brand does not become part of the scent.
