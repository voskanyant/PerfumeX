...
urlpatterns = [
    ...
    path("suppliers/<int:pk>/quick-upload/", views.SupplierQuickUploadView.as_view(), name="supplier_quick_upload"),
    path("suppliers/<int:pk>/price-sources/", views.SupplierPriceSourceCreateView.as_view(), name="supplier_price_source_create"),
    path("suppliers/<int:pk>/price-sources/<int:source_pk>/import/", views.SupplierPriceSourceImportView.as_view(), name="supplier_price_source_import"),
    path("suppliers/<int:pk>/price-sources/<int:source_pk>/delete/", views.SupplierPriceSourceDeleteView.as_view(), name="supplier_price_source_delete"),
