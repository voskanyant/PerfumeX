...
- 2026-05-03 - Operations: parser/KB migrations do not update already-saved production parses unless `PARSER_VERSION` changes and affected rows are reparsed. Do not run a full-table production reparse inside deploy; use bounded patterns or a separate background/maintenance job.
