...
- 2026-05-03 - Deploy performance: CI deploys run Django tests with `--parallel=4`; production deploy should skip unchanged requirements, static collection, normalization stats, and reparses unless explicitly requested.
