...
- 2026-05-03 - Operations: parser/KB migrations do not update already-saved production parses unless `PARSER_VERSION` changes and deploy runs `reparse_supplier_products --only-stale` before refreshing normalization stats.
