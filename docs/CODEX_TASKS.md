...
- 2026-05-06 - Performance: Broad catalogue linking filtered pages are scan-window pages, not fully materialized filtered-result pages. Keep scan windows non-overlapping so page navigation never repeats the same candidate block.
