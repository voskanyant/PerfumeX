...
- 2026-05-05 - Performance: Supplier Products AJAX search must avoid exact full counts, price-history sparklines, and previous-price delta hydration; use indexed filters, cheap deterministic ordering, and `page_size + 1` slices for pagination.
