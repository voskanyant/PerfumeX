...
- 2026-05-05 - Performance: Catalogue linking filtered pages must return a bounded page fill quickly. Do not run global exact-match scans across all Our Products and all staged Fragrantica rows inside a normal filter GET.
