...
20. Build `MatchGroup` records for likely same-product rows.
21. Staff approve/reject/link through manual decisions or bulk actions.
22. Persist links to `SupplierProduct.catalog_perfume` and optional `catalog_variant`; audit decisions.
