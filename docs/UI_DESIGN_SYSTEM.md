...
- Assistant unparsed normalization rows should mirror parsed queue columns and show a non-persistent parsed preview for visible rows instead of a blank parsed column.
