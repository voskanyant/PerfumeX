...
- Our Products linked Fragrantica rows should stay compact: show catalogue collection/audience/year as one metadata row under the product name, render the linked Fragrantica counterpart as inline green text, and avoid nested linked-match cards, a separate flags column, or repeated informational chips.
